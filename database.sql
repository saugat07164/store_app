...
-- Dumping structure for table store.cache
...
-- Dumping structure for table store.cache_locks
...
-- Dumping structure for table store.contact
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  CONSTRAINT `contact_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table store.jobs
...
-- Dumping structure for table store.job_batches
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `quantity_in_stock` bigint(20) unsigned NOT NULL,
  `warranty_period_months` bigint(20) unsigned NOT NULL,
...
-- Dumping structure for table store.product_images
...
-- Dumping structure for table store.product_sales
...
-- Dumping structure for table store.repair_jobs
CREATE TABLE IF NOT EXISTS `repair_jobs` (
  ...
  `status` enum('pending','in_progress','awaiting_parts','completed','cancelled') NOT NULL DEFAULT 'pending',
...
-- Dumping structure for table store.sales
